...
class VGG16Model2D:
    def __init__( self, modelNameSufix="", nClasses=2, dataShape=v.VGG16_2D_INPUT_DATA_SHAPE, 
                  hyperparameters=Hyperparameters.Hyperparameters(), trainParameters=TrainParameters.TrainParameters()):
        self.modelName = f'VGG16_2D{modelNameSufix}'
        ...
        self.model.add(Conv2D(self.hyperparameters.baseFilters, kernel_size=(3, 3), activation='relu', kernel_initializer='he_uniform', padding='same', name='block1_conv1'))
        self.model.add(Conv2D(self.hyperparameters.baseFilters, kernel_size=(3, 3), activation='relu', kernel_initializer='he_uniform', padding='same', name='block1_conv2'))
        self.model.add(MaxPooling2D(pool_size=(2, 2, 2), name='block1_pool'))
        
        if self.hyperparameters.useBatchNorm:
            self.model.add(BatchNormalization(axis=-1))
        
        self.model.add(Conv2D(self.hyperparameters.baseFilters*2, kernel_size=(3, 3), activation='relu', kernel_initializer='he_uniform', padding='same', name='block2_conv1'))
        self.model.add(Conv2D(self.hyperparameters.baseFilters*2, kernel_size=(3, 3), activation='relu', kernel_initializer='he_uniform', padding='same', name='block2_conv2'))
        self.model.add(MaxPooling2D(pool_size=(2, 2, 2), name='block2_pool'))

        if self.hyperparameters.useBatchNorm:
            self.model.add(BatchNormalization(axis=-1))

        self.model.add(Conv2D(self.hyperparameters.baseFilters*4, kernel_size=(3, 3), activation='relu', kernel_initializer='he_uniform', padding='same', name='block3_conv1'))
        self.model.add(Conv2D(self.hyperparameters.baseFilters*4, kernel_size=(3, 3), activation='relu', kernel_initializer='he_uniform', padding='same', name='block3_conv2'))
        self.model.add(Conv2D(self.hyperparameters.baseFilters*4, kernel_size=(3, 3), activation='relu', kernel_initializer='he_uniform', padding='same', name='block3_conv3'))
        self.model.add(MaxPooling2D(pool_size=(2, 2, 2), name='block3_pool'))
        
        if self.hyperparameters.useBatchNorm:
          self.model.add(BatchNormalization(axis=-1))
        
        self.model.add(Conv2D(self.hyperparameters.baseFilters*8, kernel_size=(3, 3), activation='relu', kernel_initializer='he_uniform', padding='same', name='block4_conv1'))
        self.model.add(Conv2D(self.hyperparameters.baseFilters*8, kernel_size=(3, 3), activation='relu', kernel_initializer='he_uniform', padding='same', name='block4_conv2'))
        self.model.add(Conv2D(self.hyperparameters.baseFilters*8, kernel_size=(3, 3), activation='relu', kernel_initializer='he_uniform', padding='same', name='block4_conv3'))
        self.model.add(MaxPooling2D(pool_size=(2, 2, 2), name='block4_pool'))
        
        if self.hyperparameters.useBatchNorm:
          self.model.add(BatchNormalization(axis=-1))
        
        self.model.add(Conv2D(self.hyperparameters.baseFilters*8, kernel_size=(3, 3), activation='relu', kernel_initializer='he_uniform', padding='same', name='block5_conv1'))
        self.model.add(Conv2D(self.hyperparameters.baseFilters*8, kernel_size=(3, 3), activation='relu', kernel_initializer='he_uniform', padding='same', name='block5_conv2'))
        self.model.add(Conv2D(self.hyperparameters.baseFilters*8, kernel_size=(3, 3), activation='relu', kernel_initializer='he_uniform', padding='same', name='block5_conv3'))
        self.model.add(MaxPooling2D(pool_size=(2, 2, 2), name='block5_pool'))
